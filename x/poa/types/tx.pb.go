...
func (m *MsgSelfRemoveValidator) Reset()         { *m = MsgSelfRemoveValidator{} }
func (m *MsgSelfRemoveValidator) String() string { return proto.CompactTextString(m) }
...
func (m *MsgSelfRemoveValidator) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgSelfRemoveValidator) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgSelfRemoveValidator.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgSelfRemoveValidator) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgSelfRemoveValidator.Merge(m, src)
}
func (m *MsgSelfRemoveValidator) XXX_Size() int {
	return m.Size()
}
func (m *MsgSelfRemoveValidator) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgSelfRemoveValidator.DiscardUnknown(m)
}

var xxx_messageInfo_MsgSelfRemoveValidator proto.InternalMessageInfo

func (m *MsgSelfRemoveValidator) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *MsgSelfRemoveValidatorResponse) Reset()         { *m = MsgSelfRemoveValidatorResponse{} }
func (m *MsgSelfRemoveValidatorResponse) String() string { return proto.CompactTextString(m) }
...
func (m *MsgSelfRemoveValidatorResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgSelfRemoveValidatorResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgSelfRemoveValidatorResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgSelfRemoveValidatorResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgSelfRemoveValidatorResponse.Merge(m, src)
}
func (m *MsgSelfRemoveValidatorResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgSelfRemoveValidatorResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgSelfRemoveValidatorResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgSelfRemoveValidatorResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MsgSelfRemoveValidator)(nil), "poa.MsgSelfRemoveValidator")
	proto.RegisterType((*MsgSelfRemoveValidatorResponse)(nil), "poa.MsgSelfRemoveValidatorResponse")
}
...
var fileDescriptor_8ac16a0aed23c2e2 = []byte{
	...
	,
}
...
func (c *msgClient) SelfRemoveValidator(ctx context.Context, in *MsgSelfRemoveValidator, opts ...grpc.CallOption) (*MsgSelfRemoveValidatorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/poa.Msg/SelfRemoveValidator", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMsgServer) SelfRemoveValidator(ctx context.Context, req *MsgSelfRemoveValidator) (*MsgSelfRemoveValidatorResponse, error) {
...
func _Msg_SelfRemoveValidator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/poa.Msg/SelfRemoveValidator",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *MsgSelfRemoveValidator) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgSelfRemoveValidator) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgSelfRemoveValidator) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgSelfRemoveValidatorResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgSelfRemoveValidatorResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgSelfRemoveValidatorResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgSelfRemoveValidator) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgSelfRemoveValidatorResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgSelfRemoveValidator) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgSelfRemoveValidator: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgSelfRemoveValidator: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgSelfRemoveValidatorResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgSelfRemoveValidatorResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgSelfRemoveValidatorResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
