...
func (mr *MockStakingKeeperMockRecorder) GetUnbondingDelegationsFromValidator(ctx, validator any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStakingKeeperMockRecorder) GetValidators(ctx, maxRetrieve any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStakingKeeperMockRecorder) RemoveValidatorTokens(ctx, validator, tokensToRemove any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStakingKeeperMockRecorder) RemoveValidatorTokensAndShares(ctx, validator, sharesToRemove any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStakingKeeperMockRecorder) SlashUnbondingDelegation(ctx, ubd, infractionHeight, slashFactor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStakingKeeperMockRecorder) Unbond(ctx, delAddr, valAddr, shares any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
