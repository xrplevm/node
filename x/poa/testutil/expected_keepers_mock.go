...
func (m *MockStakingKeeper) GetAllDelegations(ctx types.Context) []types0.Delegation {
	m.ctrl.T.Helper()
...
func (m *MockStakingKeeper) GetValidators(ctx types.Context, maxRetrieve uint32) []types0.Validator {
	m.ctrl.T.Helper()
