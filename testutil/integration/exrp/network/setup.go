...
type genSetupFn func(evmosApp *app.App, genesisState evmostypes.GenesisState, customGenesis interface{}) (evmostypes.GenesisState, error)
...
var genesisSetupFunctions = map[string]genSetupFn{
	evmtypes.ModuleName:       func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	// erc20types.ModuleName:     genStateSetter[*erc20types.GenesisState](erc20types.ModuleName),
	erc20types.ModuleName: func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
	...
	infltypes.ModuleName:      func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	feemarkettypes.ModuleName: func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		// no-op. Consensus does not have a genesis state on the application
		// but the params are used on it
		// (e.g. block max gas, max bytes).
		// This is handled accordingly on chain and context initialization
	...
	distrtypes.ModuleName:     func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	slashingtypes.ModuleName: func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	authztypes.ModuleName: func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	banktypes.ModuleName:      func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	// authtypes.ModuleName:      setAuthGenesisState,
	authtypes.ModuleName: func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	epochstypes.ModuleName: func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	...
	capabilitytypes.ModuleName: func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		// no-op. Consensus does not have a genesis state on the application
		// but the params are used on it
		// (e.g. block max gas, max bytes).
		// This is handled accordingly on chain and context initialization
	...
	stakingtypes.ModuleName:    func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	evidencetypes.ModuleName:   func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	proposal.ModuleName:        func(_ *app.App, genesisState evmostypes.GenesisState, customGenesis interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	poatypes.ModuleName:        func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
			return genesisState, nil
		},
	govtypes.ModuleName: func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		// no-op. Consensus does not have a genesis state on the application
		// but the params are used on it
		// (e.g. block max gas, max bytes).
		// This is handled accordingly on chain and context initialization
	...
	upgradetypes.ModuleName: func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	feegrant.ModuleName: func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	"ibc": func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	genutiltypes.ModuleName: func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	vestingtypes.ModuleName: func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	crisistypes.ModuleName: func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
	"transfer": func(_ *app.App, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
		return genesisState, nil
	},
}
...
func genStateSetter[T proto.Message](moduleName string) genSetupFn {
	return func(evmosApp *app.App, genesisState evmostypes.GenesisState, customGenesis interface{}) (evmostypes.GenesisState, error) {
...
func setDefaultStakingGenesisState(evmosApp *app.App, genesisState evmostypes.GenesisState, overwriteParams StakingCustomGenesisState) evmostypes.GenesisState {
	// Set staking params
...
func setDefaultBankGenesisState(evmosApp *app.App, genesisState evmostypes.GenesisState, overwriteParams BankCustomGenesisState) evmostypes.GenesisState {
...
func setDefaultSlashingGenesisState(evmosApp *app.App, genesisState evmostypes.GenesisState, overwriteParams SlashingCustomGenesisState) evmostypes.GenesisState {
...
func setBankGenesisState(evmosApp *app.App, genesisState evmostypes.GenesisState, customGenesis interface{}) (evmostypes.GenesisState, error) {
...
func setDefaultAuthGenesisState(evmosApp *app.App, genesisState evmostypes.GenesisState, genAccs []authtypes.GenesisAccount) evmostypes.GenesisState {
...
func setAuthGenesisState(evmosApp *app.App, genesisState evmostypes.GenesisState, customGenesis interface{}) (evmostypes.GenesisState, error) {
...
func setDefaultGovGenesisState(evmosApp *app.App, genesisState evmostypes.GenesisState, overwriteParams GovCustomGenesisState) evmostypes.GenesisState {
...
func setDefaultErc20GenesisState(evmosApp *app.App, genesisState evmostypes.GenesisState) evmostypes.GenesisState {
...
func newDefaultGenesisState(evmosApp *app.App, params defaultGenesisParams) evmostypes.GenesisState {
...
func customizeGenesis(evmosApp *app.App, customGen CustomGenesisState, genesisState evmostypes.GenesisState) (evmostypes.GenesisState, error) {
	var err error
