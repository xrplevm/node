...
func (m *QueryOwnerAddressRequest) Reset()         { *m = QueryOwnerAddressRequest{} }
func (m *QueryOwnerAddressRequest) String() string { return proto.CompactTextString(m) }
func (*QueryOwnerAddressRequest) ProtoMessage()    {}
func (*QueryOwnerAddressRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fba814bce17cabdf, []int{6}
}
func (m *QueryOwnerAddressRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryOwnerAddressRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryOwnerAddressRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryOwnerAddressRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryOwnerAddressRequest.Merge(m, src)
}
func (m *QueryOwnerAddressRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryOwnerAddressRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryOwnerAddressRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryOwnerAddressRequest proto.InternalMessageInfo

func (m *QueryOwnerAddressRequest) GetContractAddress() string {
	if m != nil {
...
func (m *QueryOwnerAddressResponse) Reset()         { *m = QueryOwnerAddressResponse{} }
func (m *QueryOwnerAddressResponse) String() string { return proto.CompactTextString(m) }
func (*QueryOwnerAddressResponse) ProtoMessage()    {}
func (*QueryOwnerAddressResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fba814bce17cabdf, []int{7}
}
func (m *QueryOwnerAddressResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryOwnerAddressResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryOwnerAddressResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryOwnerAddressResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryOwnerAddressResponse.Merge(m, src)
}
func (m *QueryOwnerAddressResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryOwnerAddressResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryOwnerAddressResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryOwnerAddressResponse proto.InternalMessageInfo

func (m *QueryOwnerAddressResponse) GetOwnerAddress() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*QueryOwnerAddressRequest)(nil), "evmos.erc20.v1.QueryOwnerAddressRequest")
	proto.RegisterType((*QueryOwnerAddressResponse)(nil), "evmos.erc20.v1.QueryOwnerAddressResponse")
}
...
var fileDescriptor_fba814bce17cabdf = []byte{
	...
	,
}
...
func (c *queryClient) OwnerAddress(ctx context.Context, in *QueryOwnerAddressRequest, opts ...grpc.CallOption) (*QueryOwnerAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/evmos.erc20.v1.Query/OwnerAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedQueryServer) OwnerAddress(ctx context.Context, req *QueryOwnerAddressRequest) (*QueryOwnerAddressResponse, error) {
...
func _Query_OwnerAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/evmos.erc20.v1.Query/OwnerAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *QueryOwnerAddressRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryOwnerAddressRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryOwnerAddressRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryOwnerAddressResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryOwnerAddressResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryOwnerAddressResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryOwnerAddressRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryOwnerAddressResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryOwnerAddressRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryOwnerAddressRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryOwnerAddressRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryOwnerAddressResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryOwnerAddressResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryOwnerAddressResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
