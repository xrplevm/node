...
func Setup(isCheckTx bool, patchGenesis func(*App, simapp.GenesisState) simapp.GenesisState, chainID string) *App {
	return SetupWithDB(isCheckTx, patchGenesis, dbm.NewMemDB(), chainID)
}

// SetupWithDB initializes a new EthermintApp. A Nop logger is set in EthermintApp.
func SetupWithDB(isCheckTx bool, patchGenesis func(*App, simapp.GenesisState) simapp.GenesisState, db dbm.DB, chainID string) *App {
