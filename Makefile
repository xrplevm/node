...
docker-build:
	...
	docker create --name exrp -t -i tharsis/exrp:latest exrp
	# move the binaries to the ./build directory
	mkdir -p ./build/
	docker cp exrp:/usr/bin/exrpd ./build/
...
PACKAGE_NAME:=github.com/Peersyst/xrp-evm/packages/blockchain
