...
import (
	...
	gaia "github.com/xrplevm/node/v8/app"
)
...
func updateApplicationState(app *gaia.App, args valArgs) error {
	...
	params.MinDeposit = sdk.NewCoins(sdk.NewInt64Coin(gaia.BaseDenom, 1))
	params.ExpeditedMinDeposit = sdk.NewCoins(sdk.NewInt64Coin(gaia.BaseDenom, 1))
	...
	defaultCoins := sdk.NewCoins(
		sdk.NewInt64Coin(gaia.BaseDenom, 1000000000000000000),
	)
	...
	if args.xrpOwnerAddress != nil {
		pair, found := app.Erc20Keeper.GetTokenPair(appCtx, app.Erc20Keeper.GetTokenPairID(appCtx, gaia.BaseDenom))
		if !found {
